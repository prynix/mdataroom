...
class ServiceController extends CI_Controller {
        ...
        private $base="_FILES/";
        private $script_url="clientAPI/front_iframe.js";
        private $click_url="index.php/ServiceController/process_click_request/";
        ...
        private function get_cookie_data(){           
            ...
            if(isset($_COOKIE['placements'])&& isset($_COOKIE['banners'])){
    ...
    public function testDate(){
            ...
            echo gmDate("Y-m-d H:i:s",time()+(6*3600));
            
            $date= gmdate("U",time()+(6*3600));
            echo $date;
