insert into advertiser (id, name, address, email, contact_no) values (1, 'Unilever Bangladesh', 'ZN Tower (Ground Floor), Plot-2, Road-8, Bir Uttam Mir Shawkat Sarak, Dhaka 1212, Bangladesh', 'info@unilever.com', '+880 1745-576878');
insert into advertiser (id, name, address, email, contact_no) values (2, 'Robi Axiata Limited', '53 Gulshan South Avenue Gulshan 1', 'info@robi.com.bd', '+88 02 9887146-52');
